...
from robtmpl.workflow.resource.base import ResourceDescriptor
...
class StateError(WorkflowState):
    ...
    def from_dict(doc):
        ...
        Returns
        -------
        robtmpl.workflow.state.StateError
...
class StatePending(WorkflowState):
    ...
    def from_dict(doc):
        ...
        Returns
        -------
        robtmpl.workflow.state.StatePending
    ...
    def start(self):
        ...
        Returns
        -------
        robtmpl.workflow.state.StateRunning
        """
...
class StateRunning(WorkflowState):
    ...
    def success(self, resources=None):
        ...
        Parameters
        ----------
        resources: dict(robtmpl.workflow.resource.ResourceDescriptor), optional
            Optional dictionary of created resources

        Returns
        -------
        robtmpl.workflow.state.StateSuccess
        """
        return StateSuccess(
            created_at=self.created_at,
            started_at=self.started_at,

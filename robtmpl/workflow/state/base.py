...
class StatePending(WorkflowState):
    ...
    def error(self, messages=None):
        ...
        Returns
        -------
        robtmpl.workflow.state.base.StateError
        """
        ts = datetime.now()
        return StateError(
            created_at=self.created_at,
    ...
    def start(self):
        ...
        Returns
        -------
        robtmpl.workflow.state.base.StateRunning
        """
...
class StateRunning(WorkflowState):
    ...
    def success(self, files=None):
        ...
        Parameters
        ----------
        files: dict(robtmpl.workflow.resource.FileResource), optional
            Optional dictionary of created files

        Returns
        -------
        robtmpl.workflow.state.base.StateSuccess
        """
        return StateSuccess(
            created_at=self.created_at,
            started_at=self.started_at,
...
class StateSuccess(WorkflowState):
    ...
    def get_file(self, identifier):
        ...
        Returns
        -------
        robtmpl.workflow.resource.FileResource
        """
